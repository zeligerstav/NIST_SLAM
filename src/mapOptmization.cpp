...
public:
    ...
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pubLaserOdometryGlobal; // for TransformFusion
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pubLaserOdometryIncremental; // for IMUPreintegration
    rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pubPath; // for rviz

    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubRecentKeyFrame; // for rviz
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubCloudRegisteredRaw; // for rviz
    rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pubLoopConstraintEdge; // for rviz

    rclcpp::Service<lio_sam::srv::SaveMap>::SharedPtr srvSaveMap;
    rclcpp::Subscription<lio_sam::msg::CloudInfo>::SharedPtr subCloud; // from FeatureExtraction
    rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr subLoop; // TODO: where is this from?
    ...
    void updateInitialGuess()
    {
        ...
        if (imuType && cloudInfo.imu_available == true)
        {
