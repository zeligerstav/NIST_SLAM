...
class FeatureExtraction : public ParamServer
{
	...
	public:
		...
		rclcpp::Subscription<lio_sam::msg::CloudInfo>::SharedPtr subLaserCloudInfo; // from ImageProjection
		rclcpp::Publisher<lio_sam::msg::CloudInfo>::SharedPtr pubLaserCloudInfo; // for MapOptimization
