	...
	class ImageProjection : public ParamServer
{
	private:
		...
		rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr subLaserCloud; // from LiDAR
		rclcpp::CallbackGroup::SharedPtr callbackGroupLidar;

		rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubExtractedCloud; // for Octomap
		rclcpp::Publisher<lio_sam::msg::CloudInfo>::SharedPtr pubLaserCloudInfo; // for FeatureExtraction

		rclcpp::Subscription<sensor_msgs::msg::Imu>::SharedPtr subImu; // from IMU
		rclcpp::CallbackGroup::SharedPtr callbackGroupImu;
		std::deque<sensor_msgs::msg::Imu> imuQueue;

		rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr subOdom; // from IMUPreintegration
